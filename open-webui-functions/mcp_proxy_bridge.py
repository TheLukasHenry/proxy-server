"""
MCP Proxy Bridge Tool for Open WebUI
...
4. The "mcp" tool will be available in chats

Usage:
- "List my available MCP tools"
- "Use google_read_file to read /data/sample.txt"
- "Execute microsoft_list_directory on /data"
"""
...
class Tools:
    ...
    async def mcp_execute(
        ...
        :param tool_name: The name of the MCP tool to execute (e.g., 'google_read_file', 'microsoft_list_directory')
